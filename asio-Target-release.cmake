...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET asio::asio
                 ...
                 $<$<CONFIG:Release>:${asio_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET asio::asio
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${asio_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET asio::asio
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${asio_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET asio::asio
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${asio_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET asio::asio
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${asio_COMPILE_OPTIONS_RELEASE}> APPEND)
